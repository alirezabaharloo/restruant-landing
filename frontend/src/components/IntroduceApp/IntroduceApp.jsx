...
export default function IntroduceApp(){
  return (
    <section className="lg:h-[400px] md:h-[835px] h-[935px] lg:flex-row flex-col 2xl:justify-end justify-start lg:items-end items-start lg:p-0 py-[4.2rem] md:rounded-r-full md:rounded-t-[0] rounded-t-[500px]  md:relative absolute md:left-[-1.5rem] left-0 xl:mr-[1rem] 2xl:max-w-[90%] max-w-full  mt-[8rem]  flex gap-[3rem] bg-white1 border-[1px] border-[#E3E3E3]"> 
      ...
      <div className='2xl:max-w-[55%] flex flex-col md:justify-start md:mt-0 mt-[3rem] justify-center items-center lg:max-w-[70%] md:max-w-[85%] max-w-[90%] lg:self-center md:self-start md:text-start text-center lg:ml-0 md:ml-[1.5rem] md:mx-0 mx-auto lg:order-2 order-1'>
